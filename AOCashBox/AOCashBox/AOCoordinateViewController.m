...
- (instancetype)init
{
    ...
    if (self) {
        ...
        AOHomeViewController* homeViewController = [AOHomeViewController new];
        ...
        [_tabBar setViewControllers:(@[homeViewController,historyViewController,settingsViewController])];
